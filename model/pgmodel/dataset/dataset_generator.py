...
class DatasetGenerator:
    ...
    def generate_dynamic_guard_telemetries_data(cls, locations, n_days=30, to_date=date.today(), df_to_use = None):
        ...
        generators[DataframeKey.CRACK.value] = CrackGenerator(max_change=5, max_cracks=5, min_cracks=1, probability_detection=0.9, var_name=RawFeatureName.CRACK.value)
    ...
    @classmethod
    def generate_random_location_dynamic(cls, day: date, min_value: float = 10, max_value: float = 100, probability_detection: float = 0.9):
